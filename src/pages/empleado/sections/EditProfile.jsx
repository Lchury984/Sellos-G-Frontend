// src/pages/empleado/sections/EditProfile.jsx
...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.msg || err.message || 'Error al actualizar el perfil');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm ui-text">Actualiza tu perfil de empleado</p>
      </div>
      ...
      <div className="ui-card p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Guardando...</> : <><Save className="w-5 h-5" /> Guardar Cambios</>}
          </button>
        </form>
      </div>
    </>
